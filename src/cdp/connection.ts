...
import Cdp from './api';
import { RawTelemetryReporterToDap, CdpTelemetryReporter } from '../telemetry/telemetryReporter';
...
export default class Connection {
  ...
  constructor(transport: Transport, rawTelemetryReporter: RawTelemetryReporterToDap) {
    this._lastId = 0;
